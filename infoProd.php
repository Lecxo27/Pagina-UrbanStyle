                    ...
                    while($fila=mysqli_fetch_array($productoinfo, MYSQLI_ASSOC)){
                        echo '
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <h4><strong>Talla: </strong>'.$fila['talla'].'</h4>';
                                if($fila['Stock']>=1){
